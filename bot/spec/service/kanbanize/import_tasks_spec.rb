...
describe Service::Kanbanize::ImportTasks do
  ...
  let(:key1){ Storage::Kanbanize::TaskData.new(team_id: team_id, board_id: board_id, task: task1).key }
  ...
  context 'calling tasks' do
    ...
    let(:key2){ Storage::Kanbanize::TaskData.new(team_id: team_id, board_id: board_id, task: task2).key }
