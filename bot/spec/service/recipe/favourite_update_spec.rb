...
describe Service::Recipe::Controller do
  ...
  let(:bot_request){ build(:bot_request, current: Topic::Users.favourites_updated(source: :users, favourite_recipe_ids:  favourites)) }
  ...
  context 'user exists' do
    ...
    let(:previous_bot_request){ build(:bot_request, current: Topic::Users.favourites_updated(source: :user, favourite_recipe_ids:  existing_favourites)) }
